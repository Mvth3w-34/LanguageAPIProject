...
namespace LanguageProjectBackend.Services
{
    ...
    public class SendGridService
    {
        ...
        private readonly string _apiKey = Environment.GetEnvironmentVariable("EMAIL_API_KEY");
        private readonly string _sender = Environment.GetEnvironmentVariable("EMAIL_SENDER");
        private readonly string templateId = Environment.GetEnvironmentVariable("TEMPLATE_ID");
        ...
        public void SendNewWordEmail(string emailFrequency)
        {
            ...
            foreach (User user in users)
            {
                ...
                else
                {
                    ...
                    //Translates the word if it doesn't exist. 
                    else
                    {
                    ...
                    //Adds the new word to the user's list
        ...
        //This method will act a general format for sending an email.
